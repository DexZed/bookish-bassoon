    ...
    render() {
      ...
      template.innerHTML = `
        <section>
          ...
          >
            <nav>
              <h6 class="footer-title libre-baskerville text-sm">SwiftCart</h6>
              <p class="link link-hover libre-baskerville text-xs">Your one-stop shop for all your fashion and lifestyle needs. Quality products, fast delivery and excellent support.</p>
