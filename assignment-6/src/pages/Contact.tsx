...
function Contact() {
  return (
    <>
<section id="contact" className="relative w-full min-h-screen bg-black text-blue-400">
<h1 className="text-4xl p-4 font-bold tracking-wide">
    Contact
</h1>
<div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-purple-800 h-32 w-full"></div>
...
<div className="relative p-5 lg:px-20 flex flex-col md:flex-row items-center justify-center">
    ...
    <div className="bg-gray-900 border border-purple-500 w-full lg:w-1/2 h-full p-5 pt-8">
        <h3 className="text-2xl font-semibold mb-5">
        My Social Media
        </h3>
      
        <div className="flex flex-col gap-3">
        <a href="#" className="flex items-center hover:text-white hover:bg-indigo-500 p-2">
    ...
    <form action="#" className="w-full md:w-1/2 border border-purple-500 p-6 bg-gray-900">
    ...
    <div>
        ...
        <input 
            type="text" id="name" 
            className="px-3 py-2 bg-gray-800 border border-gray-900 focus:border-purple-500 focus:outline-none focus:bg-gray-800 focus:text-blue-400"
            autoComplete="on"
        />
        </div>
        <div className="flex flex-col mb-3">
    ...
    <div className="w-full pt-3">
        <button type="submit" className="w-full bg-gray-900 border border-purple-500 px-4 py-2 transition duration-50 focus:outline-none font-semibold hover:bg-indigo-500 hover:text-white text-xl cursor-pointer">
        Send
        </button>
    </div>
    </form>
